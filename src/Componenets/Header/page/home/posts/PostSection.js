...
const PostSection = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://banao-social-media-server-mu.vercel.app/posts",
          {
            method: "GET",
            mode: "cors",
            headers: {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(
      `https://banao-social-media-server-mu.vercel.app/edit-post/${editPost?._id}`,
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
      ...
      <div className="container position-relative">
        <div className="row">
          <div className="col-md-8">
            <h2 className="fw-bolder mb-4">All Posts ({allpost?.length})</h2>
            {!loading ? (
          ...
          <div id="post" className="col-md-4 position-relative">
            <div className="position-sticky mt-3 top-0">
              ...
              <form onSubmit={handlePost}>
                ...
                <button
                  type="submit"
                  className="btn mt-1 py-2 w-100 rounded-5 fw-bold btn-success"
                >
                  Post
                </button>
              </form>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <form onSubmit={handleUpdate}>
            <div className="mb-3">
              <textarea
                defaultValue={editPost?.postData}
                name="editpostText"
                className="form-control"
                id="floatingTextarea"
              ></textarea>
